          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <p class="form-control-static"><?php echo $result->TempatLahir; ?></p>
                </div>
              </div>
              <div class="form-group">
                <label for="tanggallahir" class="col-md-3 control-label">Tanggal Lahir</label>
                <div class="col-md-8">
                  <p class="form-control-static"><?php echo $result->TanggalLahir; ?></p>
                </div>
              </div>
              <hr>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <p class="form-control-static"><?php echo $result->TanggalDiterima; ?></p>
                </div>
              </div>
