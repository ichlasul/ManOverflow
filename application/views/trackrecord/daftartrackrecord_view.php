      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-heading">
            <h3><?php echo isset($title) ? $title : 'Daftar TrackRecord'; ?></h3>
          </div>

          <div class="panel-body">

            <div class="row">
              <form class="form" action="<?php echo site_url('trackrecord/search'); ?>" method="post" role="form">
            ...
            <div class="row">
              ...
              <?php $this->load->view('trackrecord/trackrecord_result'); ?>
